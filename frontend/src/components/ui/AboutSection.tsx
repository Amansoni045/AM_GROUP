  ...
  return (
    ...
    >
      <div className="container-max">
        ...
        >
          <div className="bg-[var(--bg-alt)] rounded-2xl p-8 border border-[var(--border-light)] shadow-sm">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-xl bg-[var(--color-accent-soft)] flex items-center justify-center text-[var(--color-accent)] flex-shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-[var(--text-primary)] font-heading">Our Mission</h3>
            </div>
          ...
          <div className="bg-[var(--bg-alt)] rounded-2xl p-8 border border-[var(--border-light)] shadow-sm">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[var(--text-primary)] font-heading">Our Vision</h3>
            </div>
            <p className="text-[var(--text-secondary)] text-[0.95rem] leading-relaxed">
