...
const whatWeDo = [
  "Google Search, Display & Retargeting Ads",
  "Campaign Setup , A/B Testing & Creatives Review",
  "Landing Page Strategy & Conversion Tracking",
  "Spend Management & ROAS Reports",
  "Performance Scaling & Budget Optimization",
  "Audience Targeting & Funnel Strategy"
];

const deliverables = [
  "Campaign Setup, Structure & Analysis",
  "Analytics Dashboard & Detailed Reports",
  "Conversion Insights & Budget Guidance"
];

export default function PPCServicesList() {
  return (
    <section className="bg-[var(--bg-alt)] compact-section px-4 md:px-12 py-24" id="ppc-list">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              We structure campaigns around intent, optimizing every click to ensure maximum return on ad spend (ROAS) and continuous performance scaling.
            </p>
          </motion.div>
