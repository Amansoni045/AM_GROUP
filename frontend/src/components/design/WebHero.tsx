  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Websites That<br /><span style={{ color: "#B4975A" }}>Inspire & Convert</span>
        </motion.h1>
        <motion.p
        ...
        >
          Beautiful, high-performance websites designed to impress visitors and drive measurable business results.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
