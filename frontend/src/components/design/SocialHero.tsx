  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Elevate Your Social<br /><span style={{ color: "#B4975A" }}>Media Presence</span>
        </motion.h1>
        <motion.p
        ...
        >
          Strategic social media management that builds community, drives engagement and grows your brand.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
