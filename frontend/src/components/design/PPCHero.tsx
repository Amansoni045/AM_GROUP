  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Maximise ROI with<br /><span style={{ color: "#B4975A" }}>Paid Advertising</span>
        </motion.h1>
        <motion.p
        ...
        >
          Data-driven PPC campaigns delivering targeted traffic and measurable returns for your business.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
