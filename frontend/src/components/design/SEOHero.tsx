  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Grow Organically with<br /><span style={{ color: "#B4975A" }}>Expert SEO</span>
        </motion.h1>
        <motion.p
        ...
        >
          Proven SEO strategies that boost visibility, drive qualified traffic and outrank your competition.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
