  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Compelling Content That<br /><span style={{ color: "#B4975A" }}>Converts</span>
        </motion.h1>
        <motion.p
        ...
        >
          Strategic content creation that engages your audience and supports measurable business growth.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
