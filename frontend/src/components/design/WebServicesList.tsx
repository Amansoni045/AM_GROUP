...
const whatWeDo = [
  "Website UI/UX Design & Structure",
  "Custom Layouts for Your Brand",
  "Responsive Design",
  "Landing, Sales & Portfolio Sites",
  "Website Redesigns & Optimization"
];

const deliverables = [
  "Complete Website Design Screens",
  "UI Kits & Assets"
];

export default function WebServicesList() {
  return (
    <section className="bg-[var(--bg-alt)] compact-section px-4 md:px-12 py-24" id="web-list">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Every page is built around your audience journey with clear messaging, simple navigation, trust signals, and strong conversion points.
            </p>
          </motion.div>
