...
const whatWeDo = [
  ...
  "Reporting, Tracking & Performance Audits",
  "Link Building & Domain Authority Growth",
  "Local & International SEO Optimization"
];

const deliverables = [
  "SEO Audit, Site Health & Site Visibility Report",
  "Keyword Strategy + Ranking Roadmap",
  "Optimized Pages, Titles, Meta & Alt Tags"
];

export default function SEOServicesList() {
  return (
    <section className="bg-[var(--bg-alt)] compact-section px-4 md:px-12 py-24" id="seo-list">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              We focus on clarity, structure, and ranking strategy, making sure the right pages appear to the right audience at the right time.
            </p>
          </motion.div>
