  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Build a Brand That<br /><span style={{ color: "#B4975A" }}>Stands Out</span>
        </motion.h1>
        <motion.p
        ...
        >
          Crafting compelling brand identities that connect with audiences and drive lasting recognition.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
