...
export default function Footer() {
  ...
  return (
    <footer className="bg-threedots-navy text-white py-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-2">
          <img src="/logo.webp" alt="AM Group Logo" className="h-10 w-auto object-contain" />
        </div>
        <div className="text-gray-500 text-sm">
          © 2024 AM Group. All Rights Reserved. Bahrain | KSA | Oman
        </div>
        <div className="flex gap-4">
          {socialIcons.map((icon, i) => (
            <a 
              key={i} 
              className="w-10 h-10 border border-gray-700 rounded-full flex items-center justify-center hover:bg-threedots-blue hover:border-threedots-blue transition-all" 
              href="#"
