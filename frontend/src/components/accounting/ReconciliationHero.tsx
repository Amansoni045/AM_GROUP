  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Accurate Account<br /><span style={{ color: "#B4975A" }}>Reconciliation</span>
        </motion.h1>
        <motion.p
        ...
        >
          Ensure financial accuracy and eliminate discrepancies with our meticulous reconciliation services.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
