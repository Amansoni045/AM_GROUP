  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Accurate &<br /><span style={{ color: "#B4975A" }}>Reliable Bookkeeping</span>
        </motion.h1>
        <motion.p
        ...
        >
          Professional bookkeeping services to keep your accounts precise, compliant, and always up to date.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
