...
export default function BacklogHero() {
  return (
    <section
      style={{
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Clear Your Financial<br /><span style={{ color: "#B4975A" }}>Backlog</span>
        </motion.h1>
        <motion.p
        ...
        >
          Get your financial records up to date and compliant with our professional backlog accounting services.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
