...
export default function BookkeepingServicesList() {
  return (
    <section className="bg-[var(--bg-alt)] py-24 px-4 md:px-12" id="bookkeeping-list">
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {reasons.map((reason, i) => (
              ...
              >
                <div className="text-3xl font-bold text-[var(--color-accent)] font-heading opacity-80 mt-1">
                  {reason.num}
                </div>
                <div>
                  <h4 className="text-xl font-bold text-[var(--text-primary)] mb-3 font-heading">{reason.title}</h4>
