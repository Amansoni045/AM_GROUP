  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Data-Driven Management<br /><span style={{ color: "#B4975A" }}>Information Systems</span>
        </motion.h1>
        <motion.p
        ...
        >
          Actionable MIS reports that give leadership the clarity needed to make confident business decisions.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
