...
export default function BacklogIntro() {
  return (
    <section className="bg-[var(--bg-main)] pt-24 pb-0 px-4 md:px-12 relative overflow-hidden" id="backlog-intro">
