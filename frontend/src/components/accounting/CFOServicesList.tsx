...
export default function CFOServicesList() {
  return (
    <section className="bg-[#f9f9f9] py-24 px-4 md:px-12" id="cfo-list">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-3xl font-bold text-[#020817] font-heading">
          ...
          >
            <h3 className="text-2xl font-bold text-[#6373f2] font-heading">
