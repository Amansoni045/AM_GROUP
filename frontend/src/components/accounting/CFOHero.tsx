  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Strategic Financial<br /><span style={{ color: "#B4975A" }}>Leadership on Demand</span>
        </motion.h1>
        <motion.p
        ...
        >
          Access experienced CFO expertise without the overhead, driving financial strategy for growing businesses.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
