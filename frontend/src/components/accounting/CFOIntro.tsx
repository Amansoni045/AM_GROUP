...
export default function CFOIntro() {
  return (
    <section className="bg-[var(--bg-main)] py-24 px-4 md:px-12 relative overflow-hidden" id="cfo-intro">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            ...
            <p>
              With <strong className="text-[var(--text-primary)]">AM Consulting</strong>, you gain access to a team with extensive, proven expertise. If you have the vision, we have the capability to bring it to life.
            </p>
          </motion.div>
        </div>
      </div>
