        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#020817] leading-tight mb-8 font-heading">
              Unlocking Value <br />
              Through <span className="text-[#6373f2]">Data Intelligence</span>
            </h2>
          ...
          >
            ...
            <div className="bg-[#f9f9f9] rounded-3xl p-10 border border-gray-100 shadow-md group hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-6xl font-bold text-[#020817] font-heading">20</span>
            ...
            <div className="bg-[#020817] rounded-3xl p-10 shadow-2xl group hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden sm:translate-y-8">
              ...
              <div className="relative z-10">
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-6xl font-bold text-white font-heading">105</span>
                  <span className="text-4xl font-bold text-[#d4af37]">+</span>
                </div>
                <div className="w-12 h-1 bg-[#d4af37] rounded mb-4" />
                <h3 className="text-xl font-bold text-white">Projects</h3>
                <p className="text-gray-400 text-sm mt-2">Transforming complex data into actionable narratives.</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-4 flex flex-col items-center">
              <div className="w-48 h-48 rounded-full border-4 border-[#d4af37] p-2 mb-6">
                <div className="w-full h-full rounded-full bg-gray-200 overflow-hidden grayscale">
                   ...
                   <div className="w-full h-full flex items-center justify-center bg-[#020817]">
                      <span className="text-white font-bold text-4xl">NS</span>
                   </div>
                </div>
              </div>
              <div className="text-center">
                <h4 className="text-xl font-bold text-[#020817] mb-1">Mr. Nishith Seth</h4>
                <p className="text-[#d4af37] font-bold text-sm tracking-widest uppercase">In Loving Memory</p>
              </div>
            </div>
            <div className="lg:col-span-8">
              <div className="flex items-center gap-3 mb-6">
                <Heart className="w-6 h-6 text-[#dc2626] fill-[#dc2626]" />
                <h3 className="text-2xl font-bold text-[#020817] font-heading">A Legacy of Innovation</h3>
              </div>
