...
const marqueeItems = [
  "Optimization", "Intelligence", "Strategy", "Insights",
  "Optimization", "Intelligence", "Strategy", "Insights",
  "Optimization", "Intelligence", "Strategy", "Insights"
];
  ...
  return (
    <section className="relative min-h-[70vh] flex flex-col bg-[#020817] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <motion.img
          src="/analytiks-hero.png"
          alt="AM Analytiks Hero"
      ...
      <div className="relative z-10 flex-grow flex flex-col justify-center items-center px-4 md:px-12 text-center py-20 mt-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            From Numbers <br />
            to <span className="text-[#d4af37]">Narratives</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Driving Strategic Growth with Intelligent Data. We transform complex data into meaningful insights that shape the future.
          </motion.p>
        </div>
      </div>
