...
export default function PredictiveIntro() {
  return (
    <section className="bg-white py-24 px-4 md:px-12 relative overflow-hidden" id="predictive-intro">
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          >
            Access <span className="text-[#d4af37]">meaningful data</span> to deliver key insights
          </motion.h2>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
