...
export default function DataAnalyticsDetails() {
  return (
    <section className="bg-[#f9f9f9] py-24 px-4 md:px-12" id="data-analytics-details">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#020817] mb-4 font-heading">
            Our Data Analytics <span className="text-[#6373f2]">Services</span>
          </h2>
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-[#020817] mb-4 font-heading group-hover:text-[#6373f2] transition-colors border-b border-gray-100 pb-4">
                  {service.title}
                </h3>
