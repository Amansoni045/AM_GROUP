...
export default function OpsDetails() {
  return (
    <section className="bg-[#f9f9f9] py-24 px-4 md:px-12" id="ops-details">
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h3 className="text-3xl font-bold text-[#020817] font-heading">Create Insight, Impact & Innovation for Financial Services</h3>
          ...
          >
            <h3 className="text-2xl font-bold text-[#020817] mb-6 font-heading">The Outsourcing Advantage</h3>
            ...
            <div className="bg-[#d4af37]/10 border-l-4 border-[#d4af37] p-6 rounded-r-xl">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-[#040b1e] text-white rounded-3xl p-10 md:p-16 relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#d4af37]/10 rounded-full blur-[40px]" />
