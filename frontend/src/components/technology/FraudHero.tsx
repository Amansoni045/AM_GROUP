  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Protect Your Business from<br /><span style={{ color: "#B4975A" }}>Financial Fraud</span>
        </motion.h1>
        <motion.p
        ...
        >
          Advanced fraud detection and prevention systems powered by data analytics and AI-driven intelligence.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
