  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          See the Future with<br /><span style={{ color: "#B4975A" }}>Predictive Analytics</span>
        </motion.h1>
        <motion.p
        ...
        >
          Leverage advanced predictive modelling to anticipate trends, mitigate risk and seize market opportunities.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
