  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Optimise Operations with<br /><span style={{ color: "#B4975A" }}>Data-Driven Insights</span>
        </motion.h1>
        <motion.p
        ...
        >
          Operational analytics that identify inefficiencies, reduce costs and improve productivity across your business.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
