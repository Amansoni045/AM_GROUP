  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Governance, Risk &<br /><span style={{ color: "#B4975A" }}>Compliance</span>
        </motion.h1>
        <motion.p
        ...
        >
          Integrated GRC frameworks ensuring your organisation meets regulatory requirements and manages risk effectively.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
