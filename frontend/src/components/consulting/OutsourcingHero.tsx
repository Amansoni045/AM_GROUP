  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Operational Excellence Through<br /><span style={{ color: "#B4975A" }}>Smart Outsourcing</span>
        </motion.h1>
        <motion.p
        ...
        >
          Reduce costs, increase efficiency and focus on your core business with our tailored outsourcing solutions.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
