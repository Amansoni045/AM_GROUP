...
export default function ConsultingAbout() {
  return (
    <section className="bg-white py-24 px-4 md:px-12 relative overflow-hidden" id="about-consulting">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#020817] leading-tight mb-8 font-heading">
              Consulting with <span className="text-[#6373f2]">Purpose</span><br />
              and <span className="text-[#d4af37]">Precision</span>
            </h2>
