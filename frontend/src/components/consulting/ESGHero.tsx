  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Sustainable Business for a<br /><span style={{ color: "#B4975A" }}>Better Future</span>
        </motion.h1>
        <motion.p
        ...
        >
          Comprehensive ESG reporting and sustainability frameworks to meet global standards and stakeholder expectations.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
