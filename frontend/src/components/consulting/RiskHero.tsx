  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "820px", position: "relative", zIndex: 1 }}>
        ...
        >
          Protect Your Business with<br /><span style={{ color: "#B4975A" }}>Proactive Risk Management</span>
        </motion.h1>
        <motion.p
        ...
        >
          Comprehensive risk assessments and mitigation strategies to keep your business resilient and secure.
        </motion.p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
