        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 font-heading leading-tight">
              Business Risk <br />
              <span className="text-[#dc2626]">Management</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-[#020817] mb-8 font-heading leading-tight">
                Mitigate Risk. <span className="text-[#dc2626]">Maximize</span> Resilience.
              </h2>
            ...
            <div className="bg-[#f9f9f9] p-10 md:p-16 rounded-[3rem] border border-gray-100 shadow-2xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#dc2626]/5 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-700" />
              <ShieldAlert className="w-16 h-16 text-[#dc2626] mb-8" />
      ...
      <section className="py-24 px-4 md:px-12 bg-[#020817]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <div className="w-24 h-1 bg-[#dc2626] mx-auto rounded-full" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {frameworkSteps.map((step, i) => (
              ...
              >
                <div className="w-14 h-14 bg-[#dc2626]/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[#dc2626] transition-colors">
                  <step.icon className="w-7 h-7 text-[#dc2626] group-hover:text-white transition-colors" />
                </div>
                <div className="text-5xl font-black text-white/5 group-hover:text-[#dc2626]/20 transition-colors mb-6 font-heading">
                  {step.id}
                </div>
                <h3 className="text-xl font-bold text-white mb-4 font-heading group-hover:text-[#dc2626] transition-colors">
                  {step.title}
                </h3>
